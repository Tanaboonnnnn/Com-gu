...
Release ชุดนี้คือ **ComGu v3.3.0** โดย GitHub release workflow จะสร้าง native packages บน runner ของแต่ละ OS/CPU ก่อนเผยแพร่
...
| CLI | x64 | ARM64 |
| --- | --- | --- |
| **Windows** | [ZIP](../../releases/download/v3.3.0/ComGu-CLI-windows-x64.zip) | [ZIP](../../releases/download/v3.3.0/ComGu-CLI-windows-arm64.zip) |
| **Linux** | [TAR.GZ](../../releases/download/v3.3.0/ComGu-CLI-linux-x64.tar.gz) | [TAR.GZ](../../releases/download/v3.3.0/ComGu-CLI-linux-arm64.tar.gz) |
