(() => {
  const EN = {
    ...
    'popup.reloadExtension': 'Reload extension',
    ...
    'popup.approvalRequired': 'ComGu can see this extension, but Desktop approval is still required.',
    'popup.browserDisconnected': 'The browser connection was disconnected in ComGu. Press Connect to restore it.',
    ...
    'composer.workspaceTitle': 'Workspace for this chat',
    'composer.workspaceChoose': 'Choose workspace',
    'composer.workspaceNoChat': 'Send the first message, then choose a workspace for this chat.',
    'composer.workspaceNoneApproved': 'No folders are approved in ComGu yet.',
    'composer.workspaceSave': 'Use this workspace',
    'composer.workspaceSaving': 'Saving workspace…',
    'composer.workspaceError': 'Workspace could not be saved.',
    'composer.workspaceExtensionStale': 'Reload the ComGu extension from chrome://extensions, then reload this ChatGPT tab.',
  ...
  const TH = {
    ...
    'popup.reloadExtension': 'โหลด Extension ใหม่',
    ...
    'popup.approvalRequired': 'ComGu เห็น extension แล้ว แต่ยังต้องอนุมัติจากแอป Desktop',
    'popup.browserDisconnected': 'การเชื่อมต่อเบราว์เซอร์ถูกตัดใน ComGu ให้กดเชื่อมต่อเพื่อเปิดใช้งานอีกครั้ง',
    ...
    'composer.workspace': 'Workspace',
    'composer.workspaceTitle': 'Workspace ของแชตนี้',
    'composer.workspaceChoose': 'เลือก Workspace',
    'composer.workspaceNoChat': 'ส่งข้อความแรกก่อน แล้วค่อยเลือก Workspace ให้แชตนี้',
    'composer.workspaceNoneApproved': 'ยังไม่มีโฟลเดอร์ที่อนุมัติไว้ใน ComGu',
    'composer.workspaceSave': 'ใช้ Workspace นี้',
    'composer.workspaceSaving': 'กำลังบันทึก Workspace…',
    'composer.workspaceError': 'บันทึก Workspace ไม่สำเร็จ',
    'composer.workspaceExtensionStale': 'โหลดส่วนขยาย ComGu ใหม่จาก chrome://extensions แล้วโหลดแท็บ ChatGPT นี้ใหม่อีกครั้ง',
